...
if v == 'y' :
  ...
  def suma_obejtiva(numbers_list,object):  #FUNCION
      ...
      for second in range(len(numbers_list)):
        if numbers_list[first] != numbers_list[second] :  #CONDICION 1  
          if object == numbers_list[first] + numbers_list[second] : #SUMA CONDICIONADA
            ...
            exit()       
  print(suma_obejtiva(numbers_list,object))             #Para dar todas las combinaciones, solo basta quitar esta línea de código               
else:
